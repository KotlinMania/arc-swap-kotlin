...
fun installProjectAndroidSdk(execOperations: ExecOperations) {
    ...
    androidSdkInstallMarker.writeText(
        """
        command-line-tools=$androidCommandLineToolsRevision
        platform=android-$projectCompileSdk
        build-tools=$projectAndroidBuildTools
        """.trimIndent() + "\n",
    )
...
kotlin {
    ...
    swiftExport {
        moduleName = "ArcSwap"
        flattenPackage = "io.github.kotlinmania.arcswap"
    }

    android {
        namespace = "io.github.kotlinmania.arcswap"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "arc-swap-kotlin", version.toString())

    pom {
        name.set("arc-swap-kotlin")
        description.set("Kotlin Multiplatform port of vorner/arc-swap - Atomically swappable Arc")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/arc-swap-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/arc-swap-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/arc-swap-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/arc-swap-kotlin.git")
        }
    }
}
