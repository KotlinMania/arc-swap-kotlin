...
This file is the quick-reference operating contract for arc-swap-kotlin. The longer
...
arc-swap-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`arc-swap`](https://crates.io/crates/arc-swap). Upstream Rust is the behavioral oracle while the
